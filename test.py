...
class ChangeGuildCharter(unittest.TestCase):
    ...
    def testChangeGuildCharter(self):
        ...
        self.assertEqual(r.status_code, 201)
        self.assertEqual('The NEW Charter',
                             (self.db.guild.find_one({'Foos Guild'}))["charter"])  # TODO: Test correct DB reference
...
class ChangeGuildLocation(unittest.TestCase):
    ...
    def testChangeGuildLocation(self):
        ...
        self.assertEqual(r.status_code, 201)
        self.assertEqual('Middleton',
                             (self.db.guild.find_one({'Foos Guild'}))["location"])  # TODO: Test correct DB reference
...
class ChangeGuildMembers(unittest.TestCase):
    ...
    def testChangeGuildMembers(self):
        ...
        self.assertEqual(r.status_code, 201)
        self.assertEqual(['foobar@rollforguild.com', ' barfoo@rollforguild.com'],
                            (self.db.guild.find_one({'Foos Guild'}))["members"])  # TODO: Test correct DB reference
